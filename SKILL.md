...
Run immediately:
```
node C:/Users/nafij/.claude/skills/websearch-mcp/scripts/web-search.mjs "$target"
```
...
Run immediately:
```
node C:/Users/nafij/.claude/skills/websearch-mcp/scripts/web-search.mjs --scrape "$target"
```
...
Run immediately:
```
node C:/Users/nafij/.claude/skills/websearch-mcp/scripts/open-browser.mjs "$target"
```
...
Run immediately:
```
node C:/Users/nafij/.claude/skills/websearch-mcp/scripts/fetch-youtube-transcript.mjs "$target"
```
...
Examples:
- /websearch-mcp youtube "https://www.youtube.com/watch?v=FIbk8ALTolM"
- /websearch-mcp youtube "FIbk8ALTolM" --lang en
